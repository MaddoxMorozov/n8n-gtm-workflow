...
// First run: ssh -f -N -L 3307:localhost:3306 root@173.212.247.135
const dbConfig = {
    host: 'localhost',  // Use localhost when connecting through SSH tunnel
    port: 3307,         // Local port from SSH tunnel
