...
async function main() {
    ...
    const config = {
        ssh: {
            ...
            // Add passphrase if your key is encrypted
            passphrase: process.env.SSH_PASSPHRASE || '' // Set in environment variable or leave empty if no passphrase
        },
        database: {
            host: 'localhost',
    ...
    try {
        ...
        // Example: Query data if table exists
        try {
